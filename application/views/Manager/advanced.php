    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=base_url('Admin/')?>"><i class="fa fa-circle-o"></i> General Elements</a></li>
            <li class="active"><a href="<?=base_url('Admin/c')?>"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
            <li><a href="<?=base_url('Admin/b')?>"><i class="fa fa-circle-o"></i> Editors</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
